...
@section('content')
    <form action="{{ route('reviewProject.update', $id->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" readonly class="form-control-plaintext" id="projectName" value="{{ $id->project_name }}">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" readonly class="form-control-plaintext" id="document" value="{{ $id->project_document }}">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="row mb-3">
            <div class="col-sm-10 offset-sm-2">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="gridCheck1" value="1" name="project_is_review">
